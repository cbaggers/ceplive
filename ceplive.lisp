...
(define-compiler-macro call (function &rest arguments)
  `(funcall ,function ,@arguments))

;;--------------------------------------------------

(defun member-any (items list &key (key #'identity) (test #'eql) test-not)
...
(define-compiler-macro member-any (items list &key key test test-not)
  (when (and test-not test)
    (error ":TEST and :TEST-NOT were both supplied."))
